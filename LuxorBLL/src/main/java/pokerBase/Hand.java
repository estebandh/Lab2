...
public class Hand {
	...
	public static boolean isHandRoyalFlush(Hand h, HandScore hs) {
		...
		eRank card_10 = h.getCardsInHand().get(eCardNo.FirstCard.getCardNo()).geteRank();
		eRank card_ace = h.getCardsInHand().get(eCardNo.FifthCard.getCardNo()).geteRank();

		if (card1_Suit == card5_Suit && card1_Suit == card4_Suit && card1_Suit == card3_Suit && card1_Suit == card2_Suit
				&& card_10.getiRankNbr() == 10 && card_ace.getiRankNbr() == 14) {
			bHandCheck = true;
	...
	public static boolean isHandStraightFlush(Hand h, HandScore hs) {
		...
		if ((card1_Suit == card5_Suit && card1_Suit == card4_Suit && card1_Suit == card3_Suit
				&& card1_Suit == card2_Suit) && (card1_Value.getiRankNbr() + 4 == card5_Value.getiRankNbr())) {
			bHandCheck = true;
